...
void stencil_omp_par_simd_2D_5P(uint32_t n, float *__restrict in, float *__restrict out);

void stencil_omp_par_simd_2D_9P(uint32_t n, float *__restrict in, float *__restrict out);
